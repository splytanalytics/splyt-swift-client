...
public class EventsAPI: APIBase {
     ...
     */
    public class func createEvent(customerId customerId: String, request: NewEventRequest? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func createEventWithRequestBuilder(customerId customerId: String, request: NewEventRequest? = nil) -> RequestBuilder<Void> {
        let path = "/v2/events"
