...
public class BatchAPI: APIBase {
     ...
     */
    public class func submitBatch(batchRequest batchRequest: DataCollectorBatchRequest, customerId: String, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func submitBatchWithRequestBuilder(batchRequest batchRequest: DataCollectorBatchRequest, customerId: String) -> RequestBuilder<Void> {
        let path = "/v2/batch"
