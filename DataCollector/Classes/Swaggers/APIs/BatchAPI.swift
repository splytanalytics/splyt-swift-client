...
public class BatchAPI: APIBase {
     ...
     */
    public class func submitBatch(customerId customerId: String, batchRequest: DataCollectorBatchRequest? = nil, completion: ((data: [BatchRequestResult]?, error: ErrorType?) -> Void)) {
     ...
     */
    public class func submitBatchWithRequestBuilder(customerId customerId: String, batchRequest: DataCollectorBatchRequest? = nil) -> RequestBuilder<[BatchRequestResult]> {
        let path = "/v2/batch"
