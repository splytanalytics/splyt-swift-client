...
public class MobileApplicationTrackingAPI: APIBase {
     ...
     */
    public class func submitTuneRequest(customerId customerId: String, request: DataCollectorTuneRequest? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func submitTuneRequestWithRequestBuilder(customerId customerId: String, request: DataCollectorTuneRequest? = nil) -> RequestBuilder<Void> {
        let path = "/v2/tune"
