    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: DataCollectorBaseRequest.self) { (source: AnyObject) -> DataCollectorBaseRequest in
                ...
                instance.eventProperties = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["eventProperties"])
                instance.eventTimestamp = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["eventTimestamp"])
                instance.requestType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["requestType"])
                instance.sendTimestamp = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["sendTimestamp"])
            ...
            Decoders.addDecoder(clazz: DataCollectorBeginTransactionRequest.self) { (source: AnyObject) -> DataCollectorBeginTransactionRequest in
                ...
                instance.timeoutMode = DataCollectorBeginTransactionRequest.TimeoutMode(rawValue: (sourceDictionary["timeoutMode"] as? String) ?? "") 
            ...
            Decoders.addDecoder(clazz: DataCollectorTuneRequest.self) { (source: AnyObject) -> DataCollectorTuneRequest in
                ...
                instance.campaignName = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["campaignName"])
                instance.deviceId = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["deviceId"])
                instance.eventProperties = Decoders.decodeOptional(clazz: AnyObject.self, source: sourceDictionary["eventProperties"])
                instance.eventTimestamp = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["eventTimestamp"])
                instance.requestType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["requestType"])
            ...
            Decoders.addDecoder(clazz: DataCollectorUpdateCollectionRequest.self) { (source: AnyObject) -> DataCollectorUpdateCollectionRequest in
                ...
                instance.balanceModification = Decoders.decodeOptional(clazz: Double.self, source: sourceDictionary["balanceModification"])
