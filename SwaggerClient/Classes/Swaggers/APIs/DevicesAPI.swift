...
public class DevicesAPI: APIBase {
     ...
     */
    public class func newDeviceUsingPOST(customerId customerId: String, request: DataCollectorNewDeviceRequest? = nil, checked: Bool? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func newDeviceUsingPOSTWithRequestBuilder(customerId customerId: String, request: DataCollectorNewDeviceRequest? = nil, checked: Bool? = nil) -> RequestBuilder<Void> {
        let path = "/v2/devices"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateDeviceStateUsingPUT(id id: String, customerId: String, request: DataCollectorUpdateDeviceStateRequest? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateDeviceStateUsingPUTWithRequestBuilder(id id: String, customerId: String, request: DataCollectorUpdateDeviceStateRequest? = nil) -> RequestBuilder<Void> {
