...
public class UsersAPI: APIBase {
     ...
     */
    public class func newUserUsingPOST(customerId customerId: String, request: DataCollectorNewUserRequest? = nil, checked: Bool? = nil, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func newUserUsingPOSTWithRequestBuilder(customerId customerId: String, request: DataCollectorNewUserRequest? = nil, checked: Bool? = nil) -> RequestBuilder<Void> {
        let path = "/v2/users"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateUserStateUsingPUT(id id: String, customerId: String, request: DataCollectorUpdateUserStateRequest? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func updateUserStateUsingPUTWithRequestBuilder(id id: String, customerId: String, request: DataCollectorUpdateUserStateRequest? = nil) -> RequestBuilder<Void> {
